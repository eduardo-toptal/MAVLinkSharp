...
public partial class MAVLink
{
    ...
    public class MavlinkParse
    {
        ...
        public byte[] GenerateMAVLinkPacket10(MSG_ID messageType, object indata, byte sysid = 255, byte compid = (byte)MAV_COMPONENT.MAV_COMP_ID_MISSIONPLANNER, int sequence = -1)
        {
            byte[] data;
        ...
        public byte[] GenerateMAVLinkPacket20(MSG_ID messageType, object indata, bool sign = false, byte sysid = 255, byte compid= (byte)MAV_COMPONENT.MAV_COMP_ID_MISSIONPLANNER, int sequence = -1)
        {
            byte[] data;
