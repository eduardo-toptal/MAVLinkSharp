...
namespace MAVLinkBindings {
    ...
    public struct GimbalDeviceInformationData : IMAVLinkMessageData {
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            MemoryMarshal.Write(b.Slice(p, 4), in RollMin              ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in RollMax              ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in PitchMin             ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in PitchMax             ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in YawMin               ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in YawMax               ); p+=4;
            b[p++] = (byte)(      CapFlags);
