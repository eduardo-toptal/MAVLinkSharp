...
namespace MAVLinkBindings {
    ...
    public struct StorageInformationData : IMAVLinkMessageData {
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            MemoryMarshal.Write(b.Slice(p, 4), in TotalCapacity          ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in UsedCapacity           ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in AvailableCapacity      ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in ReadSpeed              ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in WriteSpeed             ); p+=4;
            b[p++] = (byte)(StorageId);
