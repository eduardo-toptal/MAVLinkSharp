...
namespace MAVLinkBindings {
    ...
    /// </summary>    
    public struct SafetyAllowedAreaData : IMAVLinkMessageData {
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            //byte[] b = p_buffer;
            //int    p = p_offset;
            MemoryMarshal.Write(b.Slice(p, 4), in P1x       ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in P1y       ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in P1z       ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in P2x       ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in P2y       ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in P2z       ); p+=4;
            b[p++] = (byte)(Frame);
            return p;
        }
        #endregion
