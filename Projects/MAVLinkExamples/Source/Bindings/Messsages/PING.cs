...
namespace MAVLinkBindings {
    ...
    /// </summary>    
    public struct PingData : IMAVLinkMessageData {
        ...
        public byte   TargetSystem;        //0: request ping from all receiving systems. If greater than 0: message is a ping response and number is the system id of the requesting system
        public byte   TargetComponent;     //0: request ping from all receiving components. If greater than 0: message is a ping response and number is the component id of the requesting component.    
        ...
        public int Read(byte[] p_buffer,int p_offset=0) {
            ...
            Seq                   = (uint ) (b[p++] | LS8[b[p++]] | LS16[b[p++]] | LS24[b[p++]]);
