...
namespace MAVLinkBindings {
    ...
    public struct WindCovData : IMAVLinkMessageData {
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            MemoryMarshal.Write(b.Slice(p, 4), in WindX              ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in WindY              ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in WindZ              ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in VarHoriz           ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in VarVert            ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in WindAlt            ); p+=4;
