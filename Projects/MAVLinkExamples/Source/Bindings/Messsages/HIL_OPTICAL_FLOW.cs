...
namespace MAVLinkBindings {
    ...
    /// </summary>    
    public struct HilOpticalFlowData : IMAVLinkMessageData {
        ...
        public float  IntegratedX;               //Flow in radians around X axis (Sensor RH rotation about the X axis induces a positive flow. Sensor linear motion along the positive Y axis induces a negative flow.)
        public float  IntegratedY;               //Flow in radians around Y axis (Sensor RH rotation about the Y axis induces a positive flow. Sensor linear motion along the positive X axis induces a positive flow.)
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            MemoryMarshal.Write(b.Slice(p, 4), in IntegratedX                ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in IntegratedY                ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in IntegratedXgyro            ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in IntegratedYgyro            ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in IntegratedZgyro            ); p+=4;
            ...
            MemoryMarshal.Write(b.Slice(p, 4), in Distance                   ); p+=4;
