...
namespace MAVLinkBindings {
    ...
    /// </summary>    
    public struct GimbalManagerSetManualControlData : IMAVLinkMessageData {

        /// <summary>
        /// Message Id Associated w/ this Struct
        /// </summary>    
        public int GetId() { return 288; }

        public GimbalManagerFlags  Flags;               //High level gimbal manager flags.
        public float               Pitch;               //Pitch angle unitless (-1..1, positive: up, negative: down, NaN to be ignored).
        public float               Yaw;                 //Yaw angle unitless (-1..1, positive: to the right, negative: to the left, NaN to be ignored).
        public float               PitchRate;           //Pitch angular rate unitless (-1..1, positive: up, negative: down, NaN to be ignored).
        public float               YawRate;             //Yaw angular rate unitless (-1..1, positive: to the right, negative: to the left, NaN to be ignored).
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            MemoryMarshal.Write(b.Slice(p, 4), in PitchRate            ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in YawRate              ); p+=4;
