...
namespace MAVLinkBindings {
    ...
    public struct HilControlsData : IMAVLinkMessageData {
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            MemoryMarshal.Write(b.Slice(p, 4), in RollAilerons       ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in PitchElevator      ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in YawRudder          ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in Throttle           ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in Aux1               ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in Aux2               ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in Aux3               ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in Aux4               ); p+=4;
            b[p++] = (byte)(Mode);
            b[p++] = (byte)(NavMode);
            return p;
        }
