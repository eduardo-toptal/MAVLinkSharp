...
namespace MAVLinkBindings {
    ...
    public struct WinchStatusData : IMAVLinkMessageData {
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            MemoryMarshal.Write(b.Slice(p, 4), in LineLength      ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in Speed           ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in Tension         ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in Voltage         ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in Current         ); p+=4;
            b[p++] = (byte)(      Status);
