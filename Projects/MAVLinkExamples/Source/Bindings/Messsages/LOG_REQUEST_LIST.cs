...
namespace MAVLinkBindings {
    ...
    /// </summary>    
    public struct LogRequestListData : IMAVLinkMessageData {
        ...
        #region CTOR
        /// <summary>
        /// Instantiates a new LogRequestListData
        /// </summary>    
        public LogRequestListData() {
            Start                 = default(ushort);
            End                   = default(ushort);
        ...
        public int Read(byte[] p_buffer,int p_offset=0) {
            ...
            //byte[] b = p_buffer;
            //int    p = p_offset;
            Start                 = (ushort) (b[p++] | LS8[b[p++]]);
            End                   = (ushort) (b[p++] | LS8[b[p++]]);
