...
namespace MAVLinkBindings {
    ...
    /// 
    /// </summary>    
    public struct SetHomePositionData : IMAVLinkMessageData {

        /// <summary>
        /// Message Id Associated w/ this Struct
        /// </summary>    
        public int GetId() { return 243; }
        ...
        #region CTOR
        /// <summary>
        /// Instantiates a new SetHomePositionData
        /// </summary>    
        public SetHomePositionData() {
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            MemoryMarshal.Write(b.Slice(p, 4), in ApproachX         ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in ApproachY         ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in ApproachZ         ); p+=4;
