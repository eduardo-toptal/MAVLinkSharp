...
namespace MAVLinkBindings {
    ...
    /// </summary>    
    public struct PositionTargetLocalNedData : IMAVLinkMessageData {

        /// <summary>
        /// Message Id Associated w/ this Struct
        /// </summary>    
        public int GetId() { return 85; }
        ...
        #region CTOR
        /// <summary>
        /// Instantiates a new PositionTargetLocalNedData
        /// </summary>    
        public PositionTargetLocalNedData() {
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            MemoryMarshal.Write(b.Slice(p, 4), in Afx                  ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in Afy                  ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in Afz                  ); p+=4;
