...
namespace MAVLinkBindings {
    ...
    public struct OpticalFlowData : IMAVLinkMessageData {
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            MemoryMarshal.Write(b.Slice(p, 4), in FlowCompMX          ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in FlowCompMY          ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in GroundDistance      ); p+=4;
            b[p++] = (byte)(      FlowX);
            ...
            b[p++] = (byte)(SensorId);
            b[p++] = (byte)(Quality);
            MemoryMarshal.Write(b.Slice(p, 4), in FlowRateX           ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), in FlowRateY           ); p+=4;
            return p;
        }
        #endregion
