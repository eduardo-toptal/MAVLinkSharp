...
namespace MAVLinkBindings {
    ...
    /// </summary>    
    public struct ParamRequestReadData : IMAVLinkMessageData {
        ...
        public short   ParamIndex;          //Parameter index. Send -1 to use the param ID field as identifier (else the param id will be ignored)
        ...
        #region CTOR
        /// <summary>
        /// Instantiates a new ParamRequestReadData
        /// </summary>    
        public ParamRequestReadData() {
