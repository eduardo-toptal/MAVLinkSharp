...
namespace MAVLinkSharp.Bindings {
    ...
    /// </summary>    
    public struct MountOrientationData : IMAVLinkMessageData {

        /// <summary>
        /// Message Id Associated w/ this Struct
        /// </summary>    
        public int GetId() { return 265; }

        public uint   TimeBootMs;      //Timestamp (time since system boot).
        public float  Roll;            //Roll in global frame (set to NaN for invalid).
        public float  Pitch;           //Pitch in global frame (set to NaN for invalid).
        public float  Yaw;             //Yaw relative to vehicle (set to NaN for invalid).
        public float  YawAbsolute;     //Yaw in absolute frame relative to Earth's North, north is 0 (set to NaN for invalid).    
        ...
        */
        ...
        public int Read(byte[] p_buffer,int p_offset=0) {
            ...
            YawAbsolute       = (float) MemoryMarshal.Read<float >(b.Slice(p,4)); p+=4;            
            return p;
        }
        #endregion
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            MemoryMarshal.Write(b.Slice(p, 4), ref YawAbsolute      ); p+=4;
            return p;
        }
        #endregion
