...
namespace MAVLinkSharp.Bindings {
    ...
    /// 
    /// </summary>    
    public struct ParamErrorData : IMAVLinkMessageData {

        /// <summary>
        /// Message Id Associated w/ this Struct
        /// </summary>    
        public int GetId() { return 345; }

        public short               ParamIndex;          //Parameter index. Will be -1 if the param ID field should be used as an identifier (else the param id will be ignored)
        ...
        public MAVParamErrorFlags  Error;               //Error being returned to client.    

        #region CTOR
        /// <summary>
        /// Instantiates a new ParamErrorData
        /// </summary>    
        /*
        public ParamErrorData() {
            Init();
        }
        */
        public void Init() {
            ...
            ParamId               = new char[ 16];
            Error                 = default(MAVParamErrorFlags);
        }
        #endregion
