...
namespace MAVLinkSharp.Bindings {
    ...
    /// </summary>    
    public struct HilGpsData : IMAVLinkMessageData {
        ...
        public short   Vn;                    //GPS velocity in north direction in earth-fixed NED frame
        public short   Ve;                    //GPS velocity in east direction in earth-fixed NED frame
        public short   Vd;                    //GPS velocity in down direction in earth-fixed NED frame
        ...
        public byte    FixType;               //0-1: no fix, 2: 2D fix, 3: 3D fix. Some applications will not use the value of this field unless it is at least two, so always correctly fill in the fix.
        public byte    SatellitesVisible;     //Number of satellites visible. If unknown, set to UINT8_MAX
        public byte    Id;                    //GPS ID (zero indexed). Used for multiple GPS inputs
        ...
        */
        ...
        public int Read(byte[] p_buffer,int p_offset=0) {
            ...
            Vn                      = (short ) (b[p++] | LS8[b[p++]]);
            Ve                      = (short ) (b[p++] | LS8[b[p++]]);
            Vd                      = (short ) (b[p++] | LS8[b[p++]]);
