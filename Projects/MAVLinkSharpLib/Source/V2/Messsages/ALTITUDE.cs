    ...
    public struct AltitudeData : IMAVLinkMessageData {
        ...
        */
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            MemoryMarshal.Write(b.Slice(p, 4), ref AltitudeMonotonic      ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), ref AltitudeAmsl           ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), ref AltitudeLocal          ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), ref AltitudeRelative       ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), ref AltitudeTerrain        ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), ref BottomClearance        ); p+=4;
            return p;
        }
        #endregion
