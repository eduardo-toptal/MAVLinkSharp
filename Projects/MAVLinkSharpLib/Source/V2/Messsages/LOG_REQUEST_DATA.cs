...
namespace MAVLinkSharp.Bindings {
    ...
    /// </summary>    
    public struct LogRequestDataData : IMAVLinkMessageData {

        /// <summary>
        /// Message Id Associated w/ this Struct
        /// </summary>    
        public int GetId() { return 119; }
        ...
        */
        ...
        public int Read(byte[] p_buffer,int p_offset=0) {
            ...
            //byte[] b = p_buffer;
            //int    p = p_offset;
            Ofs                   = (uint  ) (b[p++] | LS8[b[p++]] | LS16[b[p++]] | LS24[b[p++]]);
            Count                 = (uint  ) (b[p++] | LS8[b[p++]] | LS16[b[p++]] | LS24[b[p++]]);
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            b[p++] = (byte)((int)Ofs>>24);
            b[p++] = (byte)(      Count);
            b[p++] = (byte)((int)Count>>8 );
            b[p++] = (byte)((int)Count>>16);
            b[p++] = (byte)((int)Count>>24);
            b[p++] = (byte)(      Id);
            b[p++] = (byte)((int)Id>>8 );
