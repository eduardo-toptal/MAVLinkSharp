...
namespace MAVLinkSharp.Bindings {
    ...
    /// </summary>    
    public struct GlobalVisionPositionEstimateData : IMAVLinkMessageData {
        ...
        public ulong    Usec;             //Timestamp (UNIX time or since system boot)
        ...
        public float[]  Covariance;       //Row-major representation of pose 6x6 cross-covariance matrix upper right triangle (states: x_global, y_global, z_global, roll, pitch, yaw; first six entries are the first ROW, next five entries are the second ROW, etc.). If unknown, assign NaN value to first element in the array.
        ...
        #region CTOR
        /// <summary>
        /// Instantiates a new GlobalVisionPositionEstimateData
        /// </summary>    
        public GlobalVisionPositionEstimateData() {
            Usec               = default(ulong);
            X                  = default(float);
            Y                  = default(float);
            Z                  = default(float);
