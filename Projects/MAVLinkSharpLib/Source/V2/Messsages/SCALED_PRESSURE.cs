...
namespace MAVLinkSharp.Bindings {
    ...
    /// </summary>    
    public struct ScaledPressureData : IMAVLinkMessageData {
        ...
        public float  PressDiff;                 //Differential pressure 1
        ...
        #region CTOR
        /// <summary>
        /// Instantiates a new ScaledPressureData
        /// </summary>    
        public ScaledPressureData() {
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            MemoryMarshal.Write(b.Slice(p, 4), ref PressAbs                   ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), ref PressDiff                  ); p+=4;
