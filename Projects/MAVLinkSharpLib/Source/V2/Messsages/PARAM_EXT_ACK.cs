...
namespace MAVLinkSharp.Bindings {
    ...
    /// </summary>    
    public struct ParamExtAckData : IMAVLinkMessageData {

        /// <summary>
        /// Message Id Associated w/ this Struct
        /// </summary>    
        public int GetId() { return 324; }
        ...
        public char[]                ParamValue;      //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise)
        public MAVParamExtTypeFlags  ParamType;       //Parameter type.
        public ParamAckFlags         ParamResult;     //Result code.    
        ...
        */
        public void Init() {
            ...
            ParamResult       = default(ParamAckFlags       );
        }
        #endregion
