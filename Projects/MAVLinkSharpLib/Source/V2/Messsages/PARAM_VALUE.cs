...
namespace MAVLinkSharp.Bindings {
    ...
    /// </summary>    
    public struct ParamValueData : IMAVLinkMessageData {
        ...
        public ushort             ParamCount;     //Total number of onboard parameters
        public ushort             ParamIndex;     //Index of this onboard parameter
        ...
        */
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            //byte[] b = p_buffer;
            //int    p = p_offset;
            MemoryMarshal.Write(b.Slice(p, 4), ref ParamValue      ); p+=4;
            b[p++] = (byte)(      ParamCount);
