...
namespace MAVLinkSharp.Bindings {
    ...
    /// </summary>    
    public struct GpsRawIntData : IMAVLinkMessageData {
        ...
        public int              Lat;                   //Latitude (WGS84, EGM96 ellipsoid)
        public int              Lon;                   //Longitude (WGS84, EGM96 ellipsoid)
        public int              Alt;                   //Altitude (MSL). Positive for up. Note that virtually all GPS modules provide the MSL altitude in addition to the WGS84 altitude.
