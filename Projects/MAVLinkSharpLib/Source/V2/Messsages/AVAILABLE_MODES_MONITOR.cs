...
namespace MAVLinkSharp.Bindings {
    ...
    /// 
    /// </summary>    
    public struct AvailableModesMonitorData : IMAVLinkMessageData {

        /// <summary>
        /// Message Id Associated w/ this Struct
        /// </summary>    
        public int GetId() { return 437; }

        public byte  Seq;    //Sequence number. The value iterates sequentially whenever AVAILABLE_MODES changes (e.g. support for a new mode is added/removed dynamically).    

        #region CTOR
        /// <summary>
        /// Instantiates a new AvailableModesMonitorData
        /// </summary>    
        /*
        public AvailableModesMonitorData() {
            Init();
        }
        */
        public void Init() {
