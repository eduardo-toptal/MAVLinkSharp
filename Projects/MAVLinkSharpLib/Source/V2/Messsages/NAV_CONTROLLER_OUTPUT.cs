    ...
    public struct NavControllerOutputData : IMAVLinkMessageData {
        ...
        */
        ...
        public int Write(byte[] p_buffer,int p_offset=0) {
            ...
            //byte[] b = p_buffer;
            //int    p = p_offset;
            MemoryMarshal.Write(b.Slice(p, 4), ref NavRoll            ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), ref NavPitch           ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), ref AltError           ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), ref AspdError          ); p+=4;
            MemoryMarshal.Write(b.Slice(p, 4), ref XtrackError        ); p+=4;
            b[p++] = (byte)(      NavBearing);
