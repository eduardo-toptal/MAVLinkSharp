...
namespace MAVLinkSharp.Bindings {
    ...
    /// </summary>    
    public struct MissionRequestPartialListData : IMAVLinkMessageData {
        ...
        public short                StartIndex;          //Start index
        public short                EndIndex;            //End index, -1 by default (-1: send list to end). Else a valid index of the list
