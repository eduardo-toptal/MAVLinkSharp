...
namespace MAVLinkSharp.Bindings {
    ...
    public enum MAVFrameFlags {
        ...
        GlobalRelativeAlt                 = 3,           //Global (WGS84) coordinate frame + altitude relative to the home position. | First value / x: latitude, second value / y: longitude, third value / z: positive altitude with 0 being at the altitude of the home position.
        LocalEnu                          = 4,           //ENU local tangent frame (x: East, y: North, z: Up) with origin fixed relative to earth.
        GlobalInt                         = 5,           //Global (WGS84) coordinate frame (scaled) + MSL altitude. First value / x: latitude in degrees*1E7, second value / y: longitude in degrees*1E7, third value / z: positive altitude over mean sea level (MSL).
        GlobalRelativeAltInt              = 6,           //Global (WGS84) coordinate frame (scaled) + altitude relative to the home position. | First value / x: latitude in degrees*1E7, second value / y: longitude in degrees*1E7, third value / z: positive altitude with 0 being at the altitude of the home position.
        ...
        GlobalTerrainAlt                  = 10,          //Global (WGS84) coordinate frame with AGL altitude (at the waypoint coordinate). First value / x: latitude in degrees, second value / y: longitude in degrees, third value / z: positive altitude in meters with 0 being at ground level in terrain model.
        GlobalTerrainAltInt               = 11,          //Global (WGS84) coordinate frame (scaled) with AGL altitude (at the waypoint coordinate). First value / x: latitude in degrees*1E7, second value / y: longitude in degrees*1E7, third value / z: positive altitude in meters with 0 being at ground level in terrain model.
        BodyFrd                           = 12,          //FRD local tangent frame (x: Forward, y: Right, z: Down) with origin that travels with vehicle. The forward axis is aligned to the front of the vehicle in the horizontal plane.
