...
namespace MAVLinkSharp.Bindings {
    ...
    /// </summary>    
    public struct ExtendedSysStateData : IMAVLinkMessageData {

        /// <summary>
        /// Message Id Associated w/ this Struct
        /// </summary>    
        public int GetId() { return 245; }

        public MAVVtolStateFlags    VtolState;       //The VTOL state if applicable. Is set to MAV_VTOL_STATE_UNDEFINED if UAV is not in VTOL configuration.
        ...
        public int Read(byte[] p_buffer,int p_offset=0) {
            ...
            //byte[] b = p_buffer;
            //int    p = p_offset;
            VtolState         = (MAVVtolStateFlags  ) (b[p++]);
